...
public class VerTorneos extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_torneos);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(VerTorneos.this,"Arreglando...","Espere...",false,false);
            }
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(VerTorneos.this,"Actualizando...","Espere...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(VerTorneos.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    private void confirmDeleteEmployee(){
        ...
        alertDialogBuilder.setMessage("¿Estas seguro de borrar este torneo?");
        ...
        alertDialogBuilder.setPositiveButton("Si",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(VerTorneos.this,VerTodo.class));
                    }
                });
